...
- 2026.08.25
    ...
    - fix: `mover start -e diskN` (empty a disk) restored, removed upstream. This build replaces the built-in mover on every Unraid version, so it is the only route to that command.
